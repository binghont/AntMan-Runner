...
//    this->addChild(blueSky);
    ...
    Menu* m = Menu::create( speedup ,small, nullptr );
...
void GameLayer::addLaserman( float dt) {
    ...
    this->scheduleOnce( schedule_selector( GameLayer::addLaser), 3.0f );
    this->scheduleOnce( schedule_selector( GameLayer::removeLaser), 3.5f );
